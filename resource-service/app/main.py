...
# # =========================
# # APP VERSION (change only this)
# # =========================
# APP_VERSION = "v1"   # v1, v2, v3, v4, v5
...
#     """
#     Priority is usable ONLY IF:
#     1. Version allows it
#     2. DB actually has the column
#     """
#     return (
...
#     status: str = "Running"
#     region: str = "East US"
#     priority: Optional[str] = None   # SAFE
...
#     for r in resources:
#         resp = ResourceResponse.from_orm(r)
#         if not can_use_priority():
#             resp.priority = None
...
#     if can_use_priority():
#         resource_kwargs["priority"] = data.priority or "Medium"
...
# =====================================================
# APP VERSION (ONLY THIS LINE CHANGES PER RELEASE)
# =====================================================
APP_VERSION = "v1"   # v1, v2, v3, v4, v5
...
async def get_templates(
    ...
    """
    Return all available Azure templates
    """
    return TEMPLATES
...
async def import_templates(
    ...
    if current_user.role != UserRole.admin:
        raise HTTPException(
            status_code=403,
            detail="Only admins can import templates"
        )
    ...
    for tid in template_ids:
        template = next(
            (t for t in TEMPLATES if t["id"] == tid),
            None
        )
        if not template:
            continue
        ...
        if can_use_priority():
            resource_kwargs["priority"] = "Medium"
